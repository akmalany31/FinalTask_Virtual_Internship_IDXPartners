 ...
 * @status
 */
public class ETL_Tr_1 implements TalendJob {
	...
	private final String jobName = "ETL_Tr_1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ETL_Tr_1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out3Struct implements routines.system.IPersistableRow<out3Struct> {
		final static byte[] commonByteArrayLock_DWH_ETL_Tr_1 = new byte[0];
		static byte[] commonByteArray_DWH_ETL_Tr_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DWH_ETL_Tr_1.length) {
					if (length < 1024 && commonByteArray_DWH_ETL_Tr_1.length == 0) {
						commonByteArray_DWH_ETL_Tr_1 = new byte[1024];
					} else {
						commonByteArray_DWH_ETL_Tr_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DWH_ETL_Tr_1, 0, length);
				strReturn = new String(commonByteArray_DWH_ETL_Tr_1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DWH_ETL_Tr_1, 0, length);
				strReturn = new String(commonByteArray_DWH_ETL_Tr_1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DWH_ETL_Tr_1) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:bGEA2VWzjxf/TPLQStfFVjexhaPDxcE6vP0S1g==");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:XuOEKqNvfHWS0/dve7oHk/bTMdBKzxWbEqKBDw==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.customer_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.customer_name = tmpContent_tDBInput_1;
								}
							} else {
								row1.customer_name = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.city_id = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.city_id = null;
							}
						}
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row2__city_id = row1.city_id;
							if (exprKeyValue_row2__city_id == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row2HashKey.city_id = (int) (Integer) exprKeyValue_row2__city_id;
							}
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.city_id = '" +
							// row2HashKey.city_id + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row3__state_id = row2.state_id;
							if (exprKeyValue_row3__state_id == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row3HashKey.state_id = (int) (Integer) exprKeyValue_row3__state_id;
							}
						...
						if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row3.state_id = '" +
							// row3HashKey.state_id + "'");
						} // G 071
...
// # Output table : 'out3'
							out3_tmp.CustomerID = row1.customer_id;
							out3_tmp.CustomerName = StringHandling.UPCASE(row1.customer_name);
							out3_tmp.Address = StringHandling.UPCASE(row1.address);
							out3_tmp.Age = row1.age;
							out3_tmp.Gender = row1.gender;
							out3_tmp.Email = row1.email;
							out3_tmp.CityName = StringHandling.UPCASE(row2.city_name);
							out3_tmp.StateName = StringHandling.UPCASE(row3.state_name);
							out3 = out3_tmp;
// ###############################
...
// Start of branch "out3"
						if (out3 != null) {
							...
							pstmt_tDBOutput_1.setInt(1, out3.CustomerID);

							if (out3.CustomerName == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, out3.CustomerName);
							}

							if (out3.Address == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, out3.Address);
							}

							if (out3.Age == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, out3.Age);
							}

							if (out3.Gender == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, out3.Gender);
							}

							if (out3.Email == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, out3.Email);
							}

							if (out3.CityName == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7, out3.CityName);
							}

							if (out3.StateName == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, out3.StateName);
							}
...
// ###############################      
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.state_id = objectIn.readInt();
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				objectOut.writeInt(this.state_id);
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(out3)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Dh5VJJnqgbxUJBsXTHDRr9d1jmLDHA85CxeMbg==");
				...
				String dbquery_tDBInput_2 = "SELECT city.city_id,\n		city.city_name,\n		city.state_id\nFROM	city";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row2.city_id = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.city_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.city_name = tmpContent_tDBInput_2;
								}
							} else {
								row2.city_name = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row2.state_id = rs_tDBInput_2.getInt(3);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						row2_HashRow.city_name = row2.city_name;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ka137D2SLPQpYDXCm/ObObkx3d0mxg05Fyv0ZQ==");

				String dbPwd_tDBInput_3 = decryptedPassword_tDBInput_3;

				String port_tDBInput_3 = "1433";
				String dbname_tDBInput_3 = "Transaction";
				String url_tDBInput_3 = "jdbc:jtds:sqlserver://" + "DESKTOP-JG7K90R";
				if (!"".equals(port_tDBInput_3)) {
					url_tDBInput_3 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_3)) {
					url_tDBInput_3 += "//" + "Transaction";
				}
				url_tDBInput_3 += ";appName=" + projectName + ";" + "integratedSecurity=true";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row3.state_id = rs_tDBInput_3.getInt(1);
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3.contains(
									...
									row3.state_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row3.state_name = tmpContent_tDBInput_3;
								}
							} else {
								row3.state_name = null;
							}
	...
	public static void main(String[] args) {
		final ETL_Tr_1 ETL_Tr_1Class = new ETL_Tr_1();

		int exitCode = ETL_Tr_1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ETL_Tr_1.class.getClassLoader()
					.getResourceAsStream("dwh/etl_tr_1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ETL_Tr_1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ETL_Tr_1");
		}
...
/************************************************************************************************
 * 117831 characters generated by Talend Open Studio for Data Integration on the
 * May 10, 2024 at 10:24:38 AM ICT
 ************************************************************************************************/