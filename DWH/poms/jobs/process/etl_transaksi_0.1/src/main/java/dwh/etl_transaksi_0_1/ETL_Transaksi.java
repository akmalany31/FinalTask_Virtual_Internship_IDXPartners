 ...
 * @status
 */
public class ETL_Transaksi implements TalendJob {
	...
	private final String jobName = "ETL_Transaksi";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ETL_Transaksi.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ETL_Transaksi.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_DWH_ETL_Transaksi = new byte[0];
		static byte[] commonByteArray_DWH_ETL_Transaksi = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DWH_ETL_Transaksi.length) {
					if (length < 1024 && commonByteArray_DWH_ETL_Transaksi.length == 0) {
						commonByteArray_DWH_ETL_Transaksi = new byte[1024];
					} else {
						commonByteArray_DWH_ETL_Transaksi = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DWH_ETL_Transaksi, 0, length);
				strReturn = new String(commonByteArray_DWH_ETL_Transaksi, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DWH_ETL_Transaksi, 0, length);
				strReturn = new String(commonByteArray_DWH_ETL_Transaksi, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DWH_ETL_Transaksi) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public java.util.Date date_opened;

		public java.util.Date getDate_opened() {
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeDate(this.date_opened, dos);
		...
		public String toString() {
			...
			sb.append(",balance=" + String.valueOf(balance));
			sb.append(",date_opened=" + String.valueOf(date_opened));
			sb.append(",status=" + status);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:zlaH7Nggh5Vl3q6+kRTBddZQFQTCQrrshR210Q==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "DimAccount";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "DimAccount";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([AccountID],[AccountType],[Balance],[DateOpened],[Status],[CustomerID]) VALUES (?,?,?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:82oRea6/whjfVmhUSTdvRZzhviFq4Lv5yH/oGw==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.account_id = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.account_type = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.account_type = tmpContent_tDBInput_1;
								}
							} else {
								row1.account_type = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.balance = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.balance = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row1.date_opened = null;
						} else {

							row1.date_opened = mssqlGTU_tDBInput_1.getDate(rsmd_tDBInput_1, rs_tDBInput_1, 5);
...
// # Output table : 'out1'
							out1_tmp.AccountID = row1.account_id;
							out1_tmp.AccountType = row1.account_type;
							out1_tmp.Balance = row1.balance;
							out1_tmp.DateOpened = row1.date_opened;
							out1_tmp.Status = row1.status;
							out1_tmp.CustomerID = row1.customer_id;
							out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
						if (out1 != null) {
							...
							pstmt_tDBOutput_1.setInt(1, out1.AccountID);

							if (out1.AccountType == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, out1.AccountType);
							}

							if (out1.Balance == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(3, out1.Balance);
							}

							if (out1.DateOpened != null) {
								pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(out1.DateOpened.getTime()));
							} else {
							...
							if (out1.Status == null) {
								...
								pstmt_tDBOutput_1.setString(5, out1.Status);
							}

							if (out1.CustomerID == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(6, out1.CustomerID);
							}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DWH_ETL_Transaksi) {
				...
				try {
					...
					this.branch_location = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.branch_location, dos);
		...
		public String toString() {
			...
			sb.append(",branch_location=" + branch_location);
			sb.append("]");
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbname_tDBOutput_2 = "DWH";
				String url_tDBOutput_2 = "jdbc:jtds:sqlserver://" + "DESKTOP-JG7K90R";
				...
				url_tDBOutput_2 += ";appName=" + projectName + ";" + "integratedSecurity=true";
				dbUser_tDBOutput_2 = "";

				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:bimijjo5H1zLGK8N62EWXkyGq+ovw4YNT58lJg==");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "DimBranch";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "DimBranch";
				}
...
// ###############################
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:OZf0G7vGkKGyGELjBmEJsjLLpJfM6X81kLD/1g==");

				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;

				String port_tDBInput_2 = "1433";
				String dbname_tDBInput_2 = "Transaction";
				String url_tDBInput_2 = "jdbc:jtds:sqlserver://" + "DESKTOP-JG7K90R";
				if (!"".equals(port_tDBInput_2)) {
					url_tDBInput_2 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_2)) {
					url_tDBInput_2 += "//" + "Transaction";
				}
				url_tDBInput_2 += ";appName=" + projectName + ";" + "integratedSecurity=true";
				...
				String dbquery_tDBInput_2 = "SELECT branch.branch_id,\n		branch.branch_name,\n		branch.branch_location\nFROM	branch";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row2.branch_id = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.branch_name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.branch_name = tmpContent_tDBInput_2;
								}
							} else {
								row2.branch_name = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.branch_location = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.branch_location = tmpContent_tDBInput_2;
								}
							} else {
								row2.branch_location = null;
							}
...
// # Output table : 'out2'
							out2_tmp.BranchID = row2.branch_id;
							out2_tmp.BranchName = row2.branch_name;
							out2_tmp.BranchLocation = row2.branch_location;
							out2 = out2_tmp;
// ###############################
...
// Start of branch "out2"
						if (out2 != null) {
							...
							pstmt_tDBOutput_2.setInt(1, out2.BranchID);

							if (out2.BranchName == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, out2.BranchName);
							}

							if (out2.BranchLocation == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, out2.BranchLocation);
							}
...
// ###############################      
	...
	public static void main(String[] args) {
		final ETL_Transaksi ETL_TransaksiClass = new ETL_Transaksi();

		int exitCode = ETL_TransaksiClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ETL_Transaksi.class.getClassLoader()
					.getResourceAsStream("dwh/etl_transaksi_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ETL_Transaksi.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ETL_Transaksi");
		}
...
/************************************************************************************************
 * 103976 characters generated by Talend Open Studio for Data Integration on the
 * May 12, 2024 at 10:50:02 AM ICT
 ************************************************************************************************/